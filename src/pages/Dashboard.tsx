...
import { getProcessedXmls } from "@/utils/xmlUtils";
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Manage your ration formulas and generate labels
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <Card className="card-dashboard">
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-sm">Total XML files processed</p>
              </CardContent>
            </Card>
            ...
            <Card className="card-dashboard">
              ...
              <CardContent>
                <div className="text-3xl font-bold">
                  {/* In a real app, this would be an actual count */}
                  {Math.floor(processedXmls.length * 1.5)}
                </div>
                <p className="text-muted-foreground text-sm">Total labels generated</p>
              </CardContent>
            </Card>
              ...
              {recentXmls.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Recently processed ration formulas
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
